...
def select_corners(image: np.ndarray) -> np.ndarray:
    ...
    Opens an OpenCV window. Click the 4 corners of the chessboard in order:
    top-left, top-right, bottom-right, bottom-left (any order works, they
    get reordered automatically).
